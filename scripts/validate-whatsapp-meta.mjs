...
console.log("\nSiguiente:");
console.log("  1. npm run secrets:cloudflare   (si el Worker tiene token viejo → error 401 al enviar)");
console.log("  2. Actualiza WHATSAPP_ACCESS_TOKEN en GitHub Secrets (mismo token permanente)");
console.log("  3. npm run audit:whatsapp");
